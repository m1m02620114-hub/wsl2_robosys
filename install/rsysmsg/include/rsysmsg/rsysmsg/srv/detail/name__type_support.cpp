...
{
  new (message_memory) rsysmsg::srv::Name_Request(_init);
}

void Name_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rsysmsg::srv::Name_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Name_Request_message_member_array[1] = {
  {
    ...
    offsetof(rsysmsg::srv::Name_Request, name),  // bytes offset in struct
...
{
  return &::rsysmsg::srv::rosidl_typesupport_introspection_cpp::Name_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rsysmsg, srv, Name_Request)() {
  return &::rsysmsg::srv::rosidl_typesupport_introspection_cpp::Name_Request_message_type_support_handle;
}
...
void Name_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rsysmsg::srv::Name_Response(_init);
}

void Name_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rsysmsg::srv::Name_Response *>(message_memory);
...
{
  return &::rsysmsg::srv::rosidl_typesupport_introspection_cpp::Name_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rsysmsg, srv, Name_Response)() {
  return &::rsysmsg::srv::rosidl_typesupport_introspection_cpp::Name_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Name_service_members = {
  ...
  // see get_service_type_support_handle<rsysmsg::srv::Name>()
...
get_service_type_support_handle<rsysmsg::srv::Name>()
{
  ...
  auto service_type_support =
    &::rsysmsg::srv::rosidl_typesupport_introspection_cpp::Name_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rsysmsg, srv, Name)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rsysmsg::srv::Name>();
}
