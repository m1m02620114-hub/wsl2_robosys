...
#include "rsysmsg/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rsysmsg::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rsysmsg::msg::Num *>(
    untyped_ros_message);
...
{
  return &rsysmsg::msg::typesupport_fastrtps_cpp::_Num__handle;
}
