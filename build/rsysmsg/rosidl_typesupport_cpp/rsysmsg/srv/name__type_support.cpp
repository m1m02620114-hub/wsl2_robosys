...
static const _Name_Request_type_support_symbol_names_t _Name_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rsysmsg, srv, Name_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rsysmsg, srv, Name_Request)),
  }
};
...
{
  return &::rsysmsg::srv::rosidl_typesupport_cpp::Name_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rsysmsg, srv, Name_Request)() {
  return get_message_type_support_handle<rsysmsg::srv::Name_Request>();
}
...
static const _Name_Response_type_support_symbol_names_t _Name_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rsysmsg, srv, Name_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rsysmsg, srv, Name_Response)),
  }
};
...
{
  return &::rsysmsg::srv::rosidl_typesupport_cpp::Name_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rsysmsg, srv, Name_Response)() {
  return get_message_type_support_handle<rsysmsg::srv::Name_Response>();
}
...
static const _Name_type_support_symbol_names_t _Name_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rsysmsg, srv, Name)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rsysmsg, srv, Name)),
  }
};
...
{
  return &::rsysmsg::srv::rosidl_typesupport_cpp::Name_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, rsysmsg, srv, Name)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<rsysmsg::srv::Name>();
}
