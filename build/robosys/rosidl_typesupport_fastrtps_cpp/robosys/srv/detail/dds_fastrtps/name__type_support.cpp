...
#include "robosys/srv/detail/name__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  // Member: name
  robosys::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.name,
    cdr);
  return true;
}
...
{
  // Member: name
  robosys::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    robosys::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: name
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robosys::msg::typesupport_fastrtps_cpp::max_serialized_size_String(
  ...
  if (is_plain) {
    ...
    using DataType = robosys::srv::Name_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robosys::srv::Name_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robosys::srv::Name_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_robosys
const rosidl_message_type_support_t *
get_message_type_support_handle<robosys::srv::Name_Request>()
{
  return &robosys::srv::typesupport_fastrtps_cpp::_Name_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for robosys::msg::String already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robosys::srv::Name_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robosys::srv::Name_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robosys::srv::Name_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robosys::srv::typesupport_fastrtps_cpp::_Name_Response__handle;
}
...
{
  return &robosys::srv::typesupport_fastrtps_cpp::_Name__handle;
}
