...
#ifndef ROBOSYS__SRV__DETAIL__NAME__FUNCTIONS_H_
#define ROBOSYS__SRV__DETAIL__NAME__FUNCTIONS_H_
...
#include "robosys/msg/rosidl_generator_c__visibility_control.h"

#include "robosys/srv/detail/name__struct.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_robosys
bool
 ...
 * calls
 * robosys__srv__Name_Request__init().
...
/**
 * It calls
 * robosys__srv__Name_Request__fini()
 ...
 * robosys__srv__Name_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robosys__srv__Name_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robosys__srv__Name_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robosys
...
/**
 * It calls
 * robosys__srv__Name_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robosys
...
/**
 * It allocates the memory for the array and calls
 * robosys__srv__Name_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robosys
...
/**
 * It calls
 * robosys__srv__Name_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOSYS__SRV__DETAIL__NAME__FUNCTIONS_H_
